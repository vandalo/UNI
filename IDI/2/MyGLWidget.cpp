...
void MyGLWidget::paintGL ()
{
  ...
  // Activem el VAO per a pintar elsegon Patricio
  glBindVertexArray (VAO_Patr);
...
void MyGLWidget::createBuffers ()
{
  ...
  esf.load("./models/esfera.obj");

  // Creació del Vertex Array Object del Esfer
  glGenVertexArrays(1, &VAO_esf);
  glBindVertexArray(VAO_esf);

  // Creació dels buffers del model patr
  // Buffer de posicions
  glGenBuffers(1, &VBO_esf);
  glBindBuffer(GL_ARRAY_BUFFER, VBO_esf);
