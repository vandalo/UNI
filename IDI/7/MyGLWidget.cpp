...
void MyGLWidget::paintGL ()
{
  ...
  // Activem el VAO per a pintar el vaca
...
void MyGLWidget::createBuffers ()
{
  ...
  //patr.load("/assig/idi/models/porsche.obj");
  patr.load("./models/f-16.obj");
...
void MyGLWidget::carregaShaders ()
{
  ...
  vaca = glGetUniformLocation (program->programId(), "vaca");
}
...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::scale(TG, glm::vec3(escala, escala, escala));
      if(go){
          ...
          TG = glm::translate(TG, glm::vec3(0,0,posX));
      }
      else{
          TG = glm::rotate(TG,gir,glm::vec3(0,1,0));
          TG = glm::translate(TG, glm::vec3(0,0,posX));
...
void MyGLWidget::viewTransform ()
{
  ...
  if(rota == 'Y')View = glm::rotate(View, -angleY, glm::vec3(0, 1, 0));
  else View = glm::rotate(View, -angleX, glm::vec3(1, 0, 0));
