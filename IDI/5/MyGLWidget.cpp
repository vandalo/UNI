...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::mat4(1.f);
  TG = glm::translate(TG,glm::vec3(posX,0,0));
...
void MyGLWidget::viewTransform ()
{
  ...
  /*View = glm::translate(View, glm::vec3(0, 0,-sqrt(2)));
  View = glm::rotate(View, (float)45, glm::vec3(1, 0, 0));
  View = glm::rotate(View, (float)90, glm::vec3(0, 1, 0));
  View = glm::rotate(View, -angleY, glm::vec3(0, 1, 0));
  View = glm::translate(View,glm::vec3(-posX ,0,0));
  //View = glm::translate(View, glm::vec3(1, -1, 1));*/
  View = glm::lookAt(glm::vec3(-1,1,-1),glm::vec3(posX,0,0),glm::vec3(0,1,0));
