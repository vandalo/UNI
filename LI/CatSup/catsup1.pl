...
treatResult(20, N):- NN is N + 1, main2(NN), nl, halt.
treatResult(10, N):- write('Sat con N = '), write(N), shell('. Cat model',_),	see(model), symbolicModel(M), seen, displaySol(M), halt.
